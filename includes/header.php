...
<head>
  ...
  <title><?php echo isset($pageTitle) ? $pageTitle : "Pixel Laser Prints | Engraving and design studio services in Charlottetown, PEI"; ?></title>
  <!-- Favicon -->
  ...
  <script type="application/ld+json">
    {
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "180 Belvedere Ave",
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-absolute w-100 site-navbar">
    <div class="container">
      <a class="navbar-brand" href="../index.php">
        <img src="/images/logo/logo.png" alt="Pixel logo" class="img-fluid site-logo">
      </a>
