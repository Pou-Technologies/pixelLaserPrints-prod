<!-- Header -->
<?php
$pageTitle = "Pixel Laser Prints - Catalog"; // Define el título de la página
...
<div class="container section-wrapper">
    <div class="text-center mb-5">
        <h2 class="display-3 fw-bold text-black">Welcome to our catalog</h2>
        ...
        <div class="col">
            <div class="card product-card h-100">
                ...
                <div class="card-body product-body d-flex flex-column">
                    ...
                    <p class="product-description flex-grow-1">Digital business cards, restaurant menus,
...
<div class="modal fade" id="productModal4" tabindex="-1" aria-labelledby="productModal4Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productModal4Label"> LED Illuminated Acrylic Sign</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<!-- 7 -->
<div class="modal fade" id="productModal7" tabindex="-1" aria-labelledby="productModal5Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <p><strong>Customization Options:</strong> Corporate logo in raised or engraved finish
                    ...
                    , Digital menu or promotions

                    , Direct contact or reservations</p>
                <p><strong>Identification number:</strong> 7001</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
<div class="modal fade" id="productModal8" tabindex="-1" aria-labelledby="productModal8Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productModal8Label"> Maple Leaf Wooden Structure</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <p><strong>Finish:</strong> Natural or varnished upon request</p>
                <p><strong>Dimensions:</strong> 8 ft (2.44 m), Available from 4 ft to 10 ft</p>
                <p><strong>Assembly:</strong> Modular system for easy setup and disassembly</p>
                <p><strong>Identification number:</strong> 8001</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
<script>
    document.querySelectorAll('.btn-share').forEach(button => {
        button.addEventListener('click', () => {
            // Esta es una función de compartir simulada. 
            // En un entorno real, usarías la API de Web Share
            // para mostrar el menú de compartir nativo del navegador.
            const productCard = button.closest('.product-card');
            const productName = productCard.querySelector('.product-title').textContent;
            const shareText = `¡Echa un vistazo a este producto increíble de Grabado Láser: ${productName}!`;

            // Muestra un mensaje simple para simular la acción.
            alert(`Compartiendo: "${shareText}"`);
        });
    });
</script>
