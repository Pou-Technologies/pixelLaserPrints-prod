  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-5">
      ...
      <div class="col-md-6 text-start">
        ...
        <p class="lead text-muted">We create professional engraved pieces for offices, hotels, and corporate spaces. From signage and branding displays to recognition plaques, our designs elevate your brand’s image with precision and style.</p>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      ...
      <div class="col-md-6 text-start">
        ...
        <p class="lead text-muted">We design personalized trophies, medals, and recognition plaques for teams, tournaments, and athletic events. Durable materials and fine engraving ensure every award stands out.</p>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      ...
      <div class="col-md-6 text-start">
        ...
        <p class="lead text-muted">We craft custom menus, signage, coasters, and branded accessories for restaurants, cafés, and bars. 
...
<section class="section-wrapper bg-black text-white text-center position-relative">
  <div class="container">
    ...
    <div class="position-relative d-inline-block">
      <img src="/images/general/" alt="" class="img-fluid mt-4 rounded">
...
<!-- Modal -->
    ...
    <div class="modal fade" id="customSignageModal" tabindex="-1" aria-labelledby="customSignageModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            ...
            <img src="/images/general/index/corporate.jpeg" alt="Custom Signage Detail" class="img-fluid rounded mb-3">
            <p>Our custom signage is designed with precision and style, using modern laser technology. Perfect for businesses, weddings, or personalized gifts.</p>
          </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Our premium corporate gifts are designed to leave a lasting impression. From personalized drinkware to unique engraved sets, every item blends professionalism with creativity.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="weddingModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>We bring elegance and personality to your special day with custom décor designed to capture your love story. From engraved signs to unique centerpieces, every detail is tailored for you.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="trophiesModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Celebrate milestones and achievements with personalized trophies and awards. Each design is crafted with precision and premium finishes to honor every success in style.</p>
      </div>
    </div>
  </div>
</div>
