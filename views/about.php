...
<section class="about-hero text-center text-white d-flex align-items-center justify-content-center"
  ...
  <div class="container">
    ...
    <p class="lead">A commitment to excellence, born in Prince Edward Island.</p>
  </div>
</section>
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <div class="image-wrapper rounded-5 overflow-hidden shadow-lg">
          <img src="<?php echo BASE_URL; ?>/images/general/aboutUs.JPG" alt="Owners of the company"
      ...
      <div class="col-lg-6">
        <div class="p-4 p-lg-5">
          ...
          <p class="mb-4">
            ...
            We believe in building lasting relationships, delivering innovative solutions, and providing a service that
            goes beyond expectations. Every project is a testament to our commitment to craftsmanship and our desire to
            make a real impact.
          </p>
          ...
          <div class="row align-items-center">
            <div class="mt-5 col-lg-5">
              <div class="d-inline-flex align-items-center space-x-2 border rounded-pill px-4 py-2"
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 team-card">
          ...
          <div class="card-body p-4 text-center d-flex flex-column">
            ...
            <div class="pt-3 border-top mt-auto">
              <a href="mailto:luislopez@pixellaserprints.ca" class="team-email-link d-inline-flex align-items-center gap-2 text-decoration-none small">
                ...
                <span>luislopez@pixellaserprints.ca</span>
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card h-100 p-4 rounded-4 shadow-sm border-0">
          ...
          <p class="text-secondary">We stay ahead of the curve, using the latest technologies and design trends to bring
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4 rounded-4 shadow-sm border-0">
          ...
          <p class="text-secondary">Your success is our success. We are dedicated to providing unparalleled support and
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4 rounded-4 shadow-sm border-0">
          ...
          <p class="text-secondary">We operate with complete transparency and honesty, building trust with every client
            we partner with.</p>
        </div>
      </div>
    </div>

    <div class="py-5 container" style="max-width: 700px; margin: 0 auto;">
      <img src="<?php echo BASE_URL; ?>/images/general/local.png" alt="Local Business" class="mx-auto d-block mb-3"
        style="max-width: 420px;">

      <p class="text-secondary px-3 mb-0">
        We are a proud local business based in Prince Edward Island. Every project you choose to build with us supports
        the local economy,
        helps sustain jobs, and strengthens our community. Just like choosing Canadian-made products, partnering with
        local companies keeps
